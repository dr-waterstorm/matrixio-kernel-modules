...
## Fork purpose
As matrixio does not seem to support their hardware anymore, the purpos of this fork is to make the matrixio Kernel for MATRIX Voice usable on a modern Raspberry Pi OS (bookworm) with the 6.6 kernel.
